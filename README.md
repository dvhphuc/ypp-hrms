...
* Intellij
  ```sh
  setup project JDK to version 17
...
1. Clone the repo
   ```sh
   git clone https://github.com/dvhphuc/hrms.git
   ```
2. Install JDK17
3. Install necessary dependenies we listed in (`pom.xml`)
...
Trung Nguyen - [@linkedin](https://www.linkedin.com/in/nguy%C3%AAn-nguy%E1%BB%85n-trung-037973256) - ntnguyen083@gmail.com

Hong Phuc - [@linkedin](https://linkedin.com/in/dvhphuc1407) - phuckg12002@gmail.com
...
* [Font Awesome](https://fontawesome.com)a
